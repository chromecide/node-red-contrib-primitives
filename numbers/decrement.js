module.exports = function(RED) {
    function NumberDecrementNode(config) {
        ...
        node.decrement_by = config.decrement_by*1 || 1;
        ...
        this.on('input', function(msg) {
            ...
            for(var i=0;i<node.target_property_parts.length;i++){
                ...
                if(i<node.target_property_parts.length-1){
                    ...
                    obj[propName] = propVal-node.decrement_by;
                }
            }
    ...
    RED.nodes.registerType("number-dec", NumberDecrementNode);
};